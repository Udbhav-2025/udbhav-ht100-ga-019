...
- **AI/ML**: 
  - Google Gemini 2.5 Pro / OpenAI GPT-4o / Anthropic Claude 3.5 for content generation
...
- API Keys:
  - Google Gemini API key OR OpenAI API key OR Anthropic API key
  - Stability AI API key (optional, uses placeholders if not provided)
...
- **[Development Guide](./docs/DEVELOPMENT.md)** - Technical deep-dive
- **[Project Overview](./docs/PROJECT_OVERVIEW.md)** - Complete architecture
- **[Setup Guide](./docs/SETUP.md)** - Detailed installation
- **[Checklist](./docs/CHECKLIST.md)** - Setup checklist and troubleshooting
...
### Content Creation
- Uses Gemini 2.5 Pro, GPT-4o, or Claude 3.5 for high-quality copy
